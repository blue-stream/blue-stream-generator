...
describe('GitService', () => {
    describe('#getTemplates()', () => {
        it('Should return array of templates', () => __awaiter(this, void 0, void 0, function* () {
            const templates = yield git_1.GitExecuter.getBranchList();
            chai_1.expect(templates).to.exist;
            chai_1.expect(templates).to.be.an('array');
        }));
    });
    describe('#cloneBranch()', () => {
        it('Should clone branch into work-space', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield git_1.GitExecuter.cloneSpecificBranch('template-root', path);
